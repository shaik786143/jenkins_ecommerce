...
SECRET_KEY = (
    'django-insecure-test-key-123456789'
    if 'test' in sys.argv
    else os.environ.get('DJANGO_SECRET_KEY', 'django-insecure-dev-key-123456789')
)
...
DATABASE_ROUTERS = ["my_ecommerce.routers.AnalyticsRouter"]
...
REST_FRAMEWORK = {
    ...
    'PAGE_SIZE': 100  # or any large number
}
